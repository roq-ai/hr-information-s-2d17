...
import { CustomerListPage as ShowCaseList } from 'pages/customers';
...
function DashboardPage() {
  ...
  const customerStat = useSWR<PaginatedInterface<CustomerInterface>>(
    () => `/customers`,
  ...
  const statResults: { title: string; result: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Customers',
      result: customerStat?.data?.totalCount,
